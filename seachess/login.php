                ...
                <div style="width:600px; margin:0 auto">
                    <div class="row">
                        <div class="col-sm-9 col-md-5">
                            ...
                            <div><button class="btn btn-login" type="submit" name="submit" value="Login"><span>Login </span></button></div>


                                <div><a href="registration.php?fb=0">Registration</a></div>


                                 <div class="fb-login-button" data-width="200" data-max-rows="1" data-size="small" data-button-type="login_with" data-show-faces="true" data-auto-logout-link="true" data-use-continue-as="false">Facebook</div>
